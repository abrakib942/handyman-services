      ...
      <div className="bg-[#E3F1FF] px-10 lg:px-20 lg:flex items-center gap-20 ">
        ...
        <div className="md:ml-10 flex-1">
          ...
          <p className="text-[#777777] mb-6">
            ...
            basement that needs drywall repairs. But with today’s busy
            lifestyles, who has the time or the patience to do it all yourself?
            Let us help your home run more smoothly with a wide range of
            affordable repair, improvement.
          </p>
          <Link href="/services">
